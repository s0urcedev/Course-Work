...
{#if isLoggedin === true}
    <div style="margin: auto; text-align: center;">
        <span class="header">Привіт, <b>{gotName} ({gotEmail})</b></span>
    </div>
{/if}
    ...
    {#if isLoggedin === true}
        <div style="margin: auto; text-align: center;">
            <a href="/api/testing/create-test">
                <button>Створити тест</button>
            </a>
        </div>
        <div style="margin: auto; text-align: center;">
            <a href="/uk/testing/choose-test?link=edit-test">
                <button>Редагувати тест</button>
            </a>
        </div>
        <div style="margin: auto; text-align: center;">
            <a href="/uk/testing/choose-test?link=view-tests-results">
                <button>Подивитися результати</button>
            </a>
        </div>
        <div style="margin: auto; text-align: center;">
            <a href="/uk/authorization">
                <button>Змінти обліковий запис</button>
            </a>
        </div>
        <div style="margin: auto; text-align: center;">
            <a href="/api/authorization/sign-out">
                <button>Вийти з облікового запису</button>   
            </a>
        </div>
    {:else}
        <div style="margin: auto; text-align: center;">
